...
* [Download Cells](https://activities.sugarlabs.org/en-US/sugar/addon/4658).

How to upgrade?
------------
On Sugar desktop systems;
* Use [My Settings](https://help.sugarlabs.org/my_settings.html), [Software Update](https://help.sugarlabs.org/my_settings.html#software-update), or;
* Use Browse to open [activities.sugarlabs.org](https://activities.sugarlabs.org/), search for `Cells`, then download.
